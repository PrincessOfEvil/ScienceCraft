...
public class annihilationcraft
	...
	public void load(FMLInitializationEvent event)
		...
		soulItem = new ItemSoul(3000).setItemName("soulItem");
		...
		GameRegistry.addRecipe(new ItemStack(soulItem, 8), new Object[]{ "111", "101", "111", Character.valueOf('0'), Block.slowSand,  Character.valueOf('1'), Item.glassBottle});
		...
		GameRegistry.addShapelessRecipe(new ItemStack(Item.monsterPlacer, 1, 55), new Object[]{ Item.slimeBall, Item.slimeBall, soulItem});
		GameRegistry.addShapelessRecipe(new ItemStack(Item.monsterPlacer, 1, 54), new Object[]{ Item.rottenFlesh, Item.rottenFlesh, soulItem});
		GameRegistry.addShapelessRecipe(new ItemStack(Item.monsterPlacer, 1, 51), new Object[]{ Item.arrow, Item.arrow, Item.bone, Item.bone, soulItem});
		
		LanguageRegistry.addName(soulItem, "Soul in a Bottle");

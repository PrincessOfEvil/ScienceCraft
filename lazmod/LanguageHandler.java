...
public class LanguageHandler
	...
	protected void addNames()
		{
		LanguageRegistry.addName(ScienceCraft.FField, "Force Field"); // TODO: I need to use strings. And load them. NOW.
		LanguageRegistry.addName(ScienceCraft.IrnTnk, "Iron Tank");
		LanguageRegistry.addName(ScienceCraft.WtrSrc, "Infinite Water Source");
		LanguageRegistry.addName(ScienceCraft.CrystF, "Crystal Catcher");
		...
		forL(ScienceCraft.DateHandler.BlockyLocalization, DataHandler.BlockyBlockTypeAmount, ScienceCraft.BlockyBlock);

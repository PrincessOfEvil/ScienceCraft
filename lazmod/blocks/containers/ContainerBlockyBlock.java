...
public class ContainerBlockyBlock extends Container
	...
	public ContainerBlockyBlock(InventoryPlayer inventoryPlayer, TileBlockyBlock te)
		...
		for (byte ctr = 0; ctr < ScienceCraft.dataHandler.BlockyISamount[id]; ctr++)
			{
			if (ScienceCraft.dataHandler.BlockyDangerSlot[id] == ctr)
				{
				addSlotToContainer(new SlotFurnace(inventoryPlayer.player, te, ctr, ScienceCraft.dataHandler.BlockySlotCoordX[id][ctr], ScienceCraft.dataHandler.BlockySlotCoordY[id][ctr]));
				}
			else
				{
				addSlotToContainer(new Slot(te, ctr, ScienceCraft.dataHandler.BlockySlotCoordX[id][ctr], ScienceCraft.dataHandler.BlockySlotCoordY[id][ctr]));
				}
			}

...
public class GuiBlockyBlock extends GuiContainer
    ...
    protected void drawGuiContainerForegroundLayer(int param1, int param2)
    	{
    	fontRenderer.drawString(HighEnergyCraft.DateHandler.BlockyLocalization[id], 8, 6, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
        ...
        mc.renderEngine.bindTexture("/mods/lazmod/textures/gui/"+HighEnergyCraft.DateHandler.BlockyBlockTypeName[id]+".png");
        int x = (width - xSize) / 2;
